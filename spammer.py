...
os.system("clear")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}Jangan Lupa Subscribe RANDOM TUTORIAL ya ges , disana banyak aplod script keren-keren :)")
time.sleep(3)
os.system("xdg-open https://youtube.com/@fiqro")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}ga SUBSCRIBE ga WORK !!")
time.sleep(3)
os.system("clear")
autoketik(f"""
{merah}|  ___|_ _/ _ \|  _ \ / _ \ {biru}    {biru} {kuning}/ ___||  _ \ / \  |  \/  |  \/  | ____|  _ \ {kuning} {putih}  \ \      / / \   {putih}
{merah}| |_   | | | | | |_) | | | |{biru}____{biru} {kuning}\___ \| |_) / _ \ | |\/| | |\/| |  _| | |_) |{kuning} {putih}___\ \ /\ / / _ \  {putih}
{merah}|  _|  | | |_| |  _ <| |_| |{biru}____{biru} {kuning}_|__) |  __/ ___ \| |  | | |  | | |___|  _ <_{kuning} {putih}____\ V  V / ___ \ {putih}
{merah}|_|   |___\__\_\_| \_\\___/ {biru}    {biru} {kuning}|____/|_| /_/   \_\_|  |_|_|  |_|_____|_| \_\{kuning} {putih}     \_/\_/_/   \_\{putih}
{abu}-----------------------------------------
{putih}[{biru}•{putih}] {biru}Author {putih}   : Fiqro Najiah
{putih}[{biru}•{putih}] {abu}GitHub {putih}   : Escapes Code
{putih}[{biru}•{putih}] {merah}You{putih}Tube {putih}  : RANDOM TUTORIAL
{putih}[{biru}•{putih}] {ungu}Instagram {putih}: @_fiqro
...
autoketik(f"""
{merah}
Ingat Tools Ini Hanya Untuk Mengerjai Orang Yang Bermaslah Dengan Anda Saja , Pergunakan Dengan Bijak !!
""")
nomor = input(f"{W}[{R}• {kuning}•{hijau}•{W}] {biru}Nomor Target / Ripper{W}: ")
...
for i in range(jum):
    ...
    print (f"{W}[{G}${W}]  Spam Nya Work Ges")
